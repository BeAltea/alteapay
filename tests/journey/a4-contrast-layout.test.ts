...
describe("N-D5-5 — alvos de toque ≥ 44px", () => {
  it("chat.tsx: 'Já paguei este valor' (afordância sob o menu), 'Sair' e 'Ver conversa completa' têm min-h-[44px]", () => {
    ...
    // A3 moveu o controle para baixo do menu como toggle ("Recolher conversa" | "Ver conversa completa").
    expect(classBefore(chat, ': "Ver conversa completa"}')).toContain("min-h-[44px]")
